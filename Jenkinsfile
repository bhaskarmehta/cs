    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                script {
                    sh """
                        sed -e 's|BASE_URL_PLACEHOLDER|${params.BASE_URL}|g' \
                            -e 's|USER_PLACEHOLDER|${params.USER}|g' \
                            -e 's|CPU_PLACEHOLDER|${params.CPU}|g' \
                            -e 's|RAM_PLACEHOLDER|${params.RAM}|g' \
                            -e 's|QUOTA_KB_PLACEHOLDER|${QUOTA_KB}|g' \
                            -e 's|PASSWORD_PLACEHOLDER|${params.PASSWORD}|g' \
